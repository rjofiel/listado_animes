...
export class AnimesService {
  ...
  getNextPage = (srch?: string, pos: number = 1, year?: string, isAdult: boolean = false, genero?: string, season?: string, status?: string, src?: string): Observable<any> => {
    return this.apollo.watchQuery<any>({
      query: this.nextPageSearch,
      variables: {
       search: srch,
        page: pos,
      }
